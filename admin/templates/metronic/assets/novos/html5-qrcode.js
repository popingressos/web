...
class Html5QrcodeScanner {
        ...
        if (this.html5Qrcode) {
            if (this.html5Qrcode._isScanning()) {
                this.html5Qrcode.stop().then(_ => {
                    ...
                    if ($this.verbose) {
                        console.error("Não foi possível parar o scanner", error);
                    }
					$this.html5Qrcode.clear();
					emptyHtmlContainer();
                })
    ...
    __createBasicLayout(parent) {
        ...
        parent.style.border = "0px solid silver";
    ...
    __createHeader(dashboard) {
        ...
        header.style.borderBottom = "0px solid rgba(192, 192, 192, 0.18)";
        dashboard.appendChild(header);

        const titleSpan = document.createElement("span");
        titleSpan.innerHTML = "Scanner de QR Code";
        ...
        statusSpan.style.border = "0px solid #00000000";
        ...
        headerMessageContainer.style.borderTop = "0px solid #f6f6f6";
    ...
    __createSectionControlPanel() {
        ...
        requestPermissionButton.innerHTML = "Solicitar Permissão de Câmera";
        requestPermissionButton.addEventListener("click", function () {
            requestPermissionButton.disabled = true;
            $this.__setStatus("PERMISSION");
            $this.__setHeaderMessage("Solicitando Permissão de Câmera...");

            Html5Qrcode.getCameras().then(cameras => {
                $this.__setStatus("Inativo");
        ...
        fileScanLabel.innerHTML = "&nbsp; Selecionar imagem";
    ...
    __renderCameraSelection(cameras) {
        ...
        cameraActionStartButton.innerHTML = "Iniciar Leitura";
        cameraActionContainer.appendChild(cameraActionStartButton);

        const cameraActionStopButton = document.createElement("button");
        cameraActionStopButton.innerHTML = "Parar Leitura";
        ...
        cameraActionStartButton.addEventListener('click', _ => {
            ...
            $this.html5Qrcode.start(
                ...
                .then(_ => {
                    ...
                    $this.__setStatus("Fazendo Leitura");
                })
                .catch(error => {
