					...
					<div class="col-md-12 div_ativo" style="margin-bottom:10px;padding-left:10px;padding-right:10px;padding-top:0px;margin-top:-5px;" id="informacoes-basicas">
						<div class="col-md-6" style="padding:5px;">
							<div class="col-md-12" style="background-color:#FFF;padding:10px;border-radius:5px;">
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<select name="empresa" id="empresa" class="form-control bs-select" data-live-search="true" data-show-subtext="true" onchange="javascript:relatorio_de_pdv_seleciona_empresa();">
											<option value="">---</option>
											<?
						...
						<div class="col-md-6" style="padding:5px;">
							<div class="col-md-12" style="background-color:#FFF;padding:10px;margin-bottom:10px;margin-bottom:100px;">
                                ...
                                <input type="hidden" name="local_filtro" id="local_filtro" value="carrinho_notificacao_pdv" />
								...
								<?
								$localBaseSet = "carrinho_notificacao_pdv";
								?>

								<div class="form-group" style="display:block;">
									<label class="control-label col-md-12" style="text-align:left;">Usuários/PDV</label>
									<div class="col-md-12">
										<select id="TI_numeroUnico_pdv_itens" class="multi-select input-sm" multiple="multiple">
											...
											while($rSqlItem = mysql_fetch_array($qSqlItem)) {
											?>
                                            <option value="|<?=$rSqlItem['numeroUnico']?>|"  <? if(strrpos($row['numeroUnico_pdv'],"|".$rSqlItem['numeroUnico']."|") === false) { } else { echo "selected"; } ?>><?=$rSqlItem['nome']?></option>
                                            <? } ?>
                                            <? } ?>

										</select>
										<input value="<?=$row['numeroUnico_pdv']?>" type="hidden" name="numeroUnico_pdv" id="TI_numeroUnico_pdv" />
