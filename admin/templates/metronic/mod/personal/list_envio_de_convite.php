    ...
    <div class="col-md-12" style="padding:0px;margin-top:10px;">
        ...
        <form name="forms" method="post" action="<?=$link?><?=$chave_url?><?=$_SESSION['var1']?>/<?=$_SESSION['var2']?>/" target="_self" ENCTYPE="multipart/form-data" id="formulario" class="form-horizontal form-bordered form-row-stripped">
            ...
            <input type="hidden" name="subMod" value="" />
                ...
                echo "<input type=\"hidden\" name=\"modulo\" id=\"modulo\" value=\"envio_de_convite_add\" />";
            ...
            <div class="row" style="padding-left:10px;padding-right:10px;">
                ...
                <div class="col-md-4" style="margin-bottom:10px;padding-left:5px;padding-right:5px;">
                    <div class="col-md-12" style="background-color:#FFF;padding:10px;border-radius:5px;">
                        ...
                        <? $nome_campo = "modelo_envio"; ?>
                        <div class="form-group">
                            <label class="control-label col-md-12" style="text-align:left;">Modelo de Envio</label>
                            <div class="col-md-12">
                                <select name="<?=$nome_campo?>" id="<?=$nome_campo?>" onchange="javascript:filtro_modelo_envio_de_convite('<?=$nome_campo?>');" class="form-control bs-select ">
                                    <option value="">---</option>
                                    <option value="pago">Gerar Cobrança e Aguardar Pagamento</option>
                                    <option value="cortesia">Cortesia</option>
                                </select>
                                <p class="help-block">Selecione o modelo de envio do convite</p>
                                <p id="DIV_<?=$nome_campo?>pago" style="color:#169ef4;display:<? if(trim($row[''.$nome_campo.''])=="pago") { echo "block"; } else { echo "none"; } ?>;" class="help-block">O cliente vai receber o uma cobrança relacionada ao convite enviado, e só vai ter acesso ao mesmo após realizar o pagamento.</p>
                                <p id="DIV_<?=$nome_campo?>cortesia" style="color:#169ef4;display:<? if(trim($row[''.$nome_campo.''])=="cortesia") { echo "block"; } else { echo "none"; } ?>;" class="help-block">O cliente recebe o convite imediatamente após o envio de forma gratuíta marcado como cortesia.</p>
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="DIV_qtd" style="display:<?=$display_DIV_qtd?>;">
                            <label class="control-label col-md-12" style="text-align:left;">Gênero do Ticket</label>
                            <div class="col-md-12" id="DIV_qtd_u" style="display:<?=$display_DIV_qtd_u?>;">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="qtd_u" id="qtd_u" disabled="disabled" class="form-control input-sm" value="Este ticket é UNISSEX" style="height: 34px;margin-top:0px;">
                                </div>
                            </div>
                            <div class="col-md-12" id="DIV_qtd_f" style="display:<?=$display_DIV_qtd_f?>;">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="qtd_f" id="qtd_f" disabled="disabled" class="form-control input-sm" value="Este ticket é FEMININO" style="height: 34px;margin-top:0px;">
                                </div>
                            </div>
                            <div class="col-md-12" id="DIV_qtd_m" style="display:<?=$display_DIV_qtd_m?>;">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="qtd_m" id="qtd_m" disabled="disabled" class="form-control input-sm" value="Este ticket é MASCULINO" style="height: 34px;margin-top:0px;">
                                </div>
                            </div>
                        </div>

                        <div class="form-group" id="DIV_cortesia" style="display:none;">
                            <div class="col-md-12">
                                <div class="note note-info" style="margin-bottom:0px;">
                                    <p>Este convite está sendo enviado como CORTESIA e nenhum valor será cobrado</p>
                                </div>
                            </div>
                        </div>
    ...
    <div class="botoes_salvar_rodape">
        ...
        <div class="row top-side">
            ...
            <div class="col-xs-6 col-sm-12 botoes_de_salvar top-side-desktop">
                <button type="button" class="btn yellow-gold input-label" style="margin-left: 0px;" onclick="javascript:envio_de_convite_salvar('<?=$tipo_form_set?>');" style=""><?=$nome_btn?></button>
                <button type="button" class="btn green input-label" style="margin-left: 0px;" onclick="javascript:envio_de_convite_salvar('<?=$tipo_form_set?>-continuar');" style=""><?=$nome_btn?> e Continuar Editando</button>
            </div>
            <!-- Fim menu desktop-->
        </div>
    </div>
