...
<? } else { ?>
    ...
    <div class="col-md-12" style="padding:0px;margin-top:10px;">
        ...
        <form name="forms" method="post" action="<?=$link?><?=$chave_url?><?=$_SESSION['var1']?>/<?=$_SESSION['var2']?>/" target="_self" ENCTYPE="multipart/form-data" id="formulario" class="form-horizontal form-bordered form-row-stripped">
            ...
            <input type="hidden" name="subMod" value="" />
                ...
                echo "<input type=\"hidden\" name=\"modulo\" id=\"modulo\" value=\"envio_de_ingresso_add\" />";
                ...
                <div class="<? if(trim($_REQUEST['var3'])=="novo") { ?>col-md-4<? } else { ?>col-md-6<? } ?>" style="margin-bottom:10px;padding-left:5px;padding-right:5px;">
                    <div class="col-md-12" style="background-color:#FFF;padding:10px;border-radius:5px;">
                        ...
                        <div class="form-group" id="DIV_valor" style="display:<?=$display_DIV_valor?>;">
                            <label class="control-label col-md-12" style="text-align:left;">Valor de Venda deste Ingresso</label>
                            <div class="col-md-12">
                                ...
                                <p class="help-block">Abaixo segue a lista de valores definidos nos lotes do ticket selecionado como embasamento para criação de um valor para este ingresso</p>
                            </div>
                        </div>
    ...
    <div class="botoes_salvar_rodape">
        <? 
		if(trim($_REQUEST['var3'])=="novo") { 
			$nome_btn = "Cadastrar Envio de Ingresso"; 
		?>
        <div class="row top-side">
            <!-- Inicio menu desktop-->
            <div class="col-xs-6 col-sm-12 botoes_de_salvar top-side-desktop">
                <button type="button" class="btn yellow-gold input-label" style="margin-left: 0px;" onclick="javascript:envio_de_ingresso_salvar('<?=$tipo_form_set?>');" style=""><?=$nome_btn?></button>
            </div>
            <!-- Fim menu desktop-->
        </div>
        <? } ?>
