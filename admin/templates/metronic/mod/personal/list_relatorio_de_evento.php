					...
					<div class="col-md-12 div_ativo" style="margin-bottom:10px;padding-left:10px;padding-right:10px;padding-top:0px;margin-top:-5px;" id="informacoes-basicas">
						<div class="col-md-6" style="padding:5px;">
							<div class="col-md-12" style="background-color:#FFF;padding:10px;border-radius:5px;">
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<select name="empresa" id="empresa" class="form-control bs-select" data-live-search="true" data-show-subtext="true" onchange="javascript:relatorio_de_evento_seleciona_empresa();">
											<option value="">---</option>
											<?
						...
						<div class="col-md-6" style="padding:5px;">
							<div class="col-md-12" style="background-color:#FFF;padding:10px;margin-bottom:10px;">
                                ...
                                <input type="hidden" name="local_filtro" id="local_filtro" value="carrinho_notificacao_evento" />
								...
								<div class="form-group" id="DIV_status_do_filtro" style="display:block;">
									...
									<div class="col-md-12">
										<select id="TI_status_do_filtro_itens" class="multi-select input-sm" multiple="multiple">
                                        	<optgroup label="Situação de Confirmados/Validados">
                                                <option value="|confirmado_1|"  <? if(strrpos($row['status_do_filtro'],"|confirmado_1|") === false) { } else { echo "selected"; } ?>>Confirmados</option>
                                                <option value="|confirmado_0|"  <? if(strrpos($row['status_do_filtro'],"|confirmado_0|") === false) { } else { echo "selected"; } ?>>Não confirmados</option>
                                            </optgroup>
