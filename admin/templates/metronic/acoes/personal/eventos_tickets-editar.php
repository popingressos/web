...
$_POST['numeroUnico'] = $_POST['ticket_numeroUnico'];
...
foreach ($carrinhoArray as $key => $value) {
	if(trim($_POST['ticket_numeroUnico'])==trim($value['numeroUnico'])) {

		if(trim($_FILES["ticket_imagem_de_capa"]["name"])=="") {
			$_POST['ticket_imagem_de_capa'] = $value['ticket_imagem_de_capa'];
		} else {
			$_POST['ticket_imagem_de_capa'] = $_POST['ticket_imagem_de_capa'];
		}

		if(trim($_FILES["ticket_mapa"]["name"])=="") {
			$_POST['ticket_mapa'] = $value['ticket_mapa'];
		} else {
			$_POST['ticket_mapa'] = $_POST['ticket_mapa'];
		}

		if(trim($_FILES["ticket_pdf_informativo"]["name"])=="") {
			$_POST['ticket_pdf_informativo'] = $value['ticket_pdf_informativo'];
		} else {
			$_POST['ticket_pdf_informativo'] = $_POST['ticket_pdf_informativo'];
		}
		...
		$dataControle[] = array("tag" => "eventos_tickets", 
								"numeroUnico" => "".$_POST['ticket_numeroUnico']."",
