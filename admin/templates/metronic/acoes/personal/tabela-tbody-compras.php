                                    ...
                                    <table class="table table-striped table-bordered table-hover display table-header-fixed" style="background-color:#ffffff;" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
											...
											$strSql = "
												...
												LEFT JOIN 
													produtos AS mod_produtos ON (mod_produtos.numeroUnico = mod_".$mod.".produto)
                                            ...
                                            while($rSql = mysql_fetch_array($qSql)) {
												...
												$_SESSION['alunos_treino_'.$rSql['numeroUnico'].''] = "";
												$_SESSION['alunos_treino_inativo_'.$rSql['numeroUnico'].''] = "";
                                            ...
                                            <tr id_linha="<?=$rSql['id']?>" cor_anterior="<?=$cor_anterior_set?>" <?=$style_set?> role="row">
                                                ...
                                                <td style="vertical-align:middle;"><?=$rSql['produtos_nome']?></td>
