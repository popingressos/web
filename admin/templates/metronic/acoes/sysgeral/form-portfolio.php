...
?>
                                <div style="width:100%;">
                                     ...
                                     <div class="formSep">
                                        <label>Ordem</label>
                                        <select id="ordem_video" style="width:70px;">
                                            <?
                                    ...
                                    <div class="formSep">
                                        <div style="float:left;margin-right:10px;">
                                            ...
                                            <input value="<?=$rSql['nome']?>" style="width:350px;" type="text" id="nome_video" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="formSep">
                                        <div style="float:left;margin-right:10px;">
                                            ...
                                            <input value="<?=$rSql['link']?>" style="width:350px;" type="text" id="link_video" />
                                        </div>
                                    </div>

                                    <div class="formSep">
                                        <button type="button" onclick="edita_portfolio_video_ajax('<?=$_REQUEST['idS']?>','<?=$_REQUEST['modS']?>');" class="btn btn-success">Salvar</button>
