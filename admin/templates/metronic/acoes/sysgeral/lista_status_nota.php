                                                                    ...
                                                                    <tbody>
                                                                                ...
                                                                                validate: function(value) {
                                                                                   if($.trim(value) == '') { 
                                                                                    return 'Este campo é obrigatório';
                                                                                       ...
                                                                                       edita_ordem_status_nota('<?=$rSqlCategoria['id']?>','<?=$modGet?>','<?=$subLocalGet?>',value);
                                                                                   }
                                                                                }
                                                                            });
                                                                                ...
                                                                                validate: function(value) {
                                                                                   if($.trim(value) == '') { 
                                                                                    return 'Este campo é obrigatório';
                                                                                       ...
                                                                                       salva_campo_status_nota('<?=$rSqlCategoria['id']?>','<?=$modGet?>','<?=$subLocalGet?>',value);
                                                                                   }
                                                                                }
                                                                            });
                                                                        ...
                                                                        <tr id="lista_categoria_<?=$rSqlCategoria['id']?>">
                                                                            ...
                                                                            <td style="vertical-align:middle;" class="nolink">
                                                                                <div class="btn-group">
                                                                                <a href="javascript:void(0);" onClick="remover_status_nota('<?=$modGet?>','<?=$rSqlCategoria['id']?>','<?=$subLocalGet?>');" class="btn-mini ptip_se" title="Remover"><img src="<?=$link?>template/img/icones_novos/16/remover-x.png" /></a>
																				<? if(trim($rSqlCategoria['stat'])=="1") { ?>
                                                                                    <a href="javascript:void(0);" onclick="muda_stat_status_nota('<?=$modGet?>','<?=$rSqlCategoria['id']?>','<?=$subLocalGet?>','0');" class="btn-mini ptip_se" title="Despublicar"><img src="<?=$link?>template/img/icones_novos/16/stat-1.png" /></a>
                                                                                <? } else { ?>
                                                                                    <a href="javascript:void(0);" onclick="muda_stat_status_nota('<?=$modGet?>','<?=$rSqlCategoria['id']?>','<?=$subLocalGet?>','1');" class="btn-mini ptip_se" title="Publicar"><img src="<?=$link?>template/img/icones_novos/16/stat-0.png" /></a>
                                                                                <? } ?>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
