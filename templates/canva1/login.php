                            ...
                            <form 
                             ...
                             autocomplete="off_<?=$_SESSION['empresa_'.$rSqlEmpresa['id'].'_numeroUnico_carrinho']?>">
								...
								<div class="col-12 form-group">
									...
									<a href="<?=$link_modelo?>esqueceu-sua-senha/" class="float-end">Esqueceu sua senha?</a>
								</div>

                                <? if(trim($configuracoes_site['login_facebook'])=="1" || trim($configuracoes_site['login_google'])=="1") { ?>
                                ...
                                <? if(trim($configuracoes_site['login_facebook'])=="1") { ?>
                                <div class="col-md-12 text-center">
                                ...
                                <? if(trim($configuracoes_site['login_google'])=="1") { ?>
